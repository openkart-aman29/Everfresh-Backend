// src/features/bookings/operations/update/controller/Update_Booking_Controller.ts
import { Request, Response } from 'express';
import { bookingLogger } from '@/features/company/bookings/logger/Booking_Logger';
import { updateBookingZodSchema } from '@/features/company/bookings/operations/update/zod_schema/Update_Booking_Zod_Schema';
import { sendResponse } from '@/utilities/http/http-response/Standard_Response';
import { StandardResponseInterface } from '@/utilities/global_interfaces/Standard_Response_Interface';
import { getErrorStatus } from '@/utilities/http/constants/HTTP_Status_Codes';
import { updateBookingService } from '@/features/company/bookings/operations/update/service/Update_Booking_Service';
import { ulidZodSchema } from '@/utilities/global_schemas/ULID_Zod_Schema';

/**
 * Controller: Update booking
 * Route: PATCH /api/bookings/update/:booking_id
 * Auth: Required
 */
export const updateBookingController = async (req: Request, res: Response) => {
    try {
        bookingLogger.info('Updating booking - controller', {
        ...
        // Call service
        const serviceResponse = await updateBookingService(
            bookingId,
            companyId,
            updateData
        );
        
        bookingLogger.info('Update booking completed', {
