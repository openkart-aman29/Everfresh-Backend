// src/features/bookings/operations/reschedule/controller/Reschedule_Booking_Controller.ts
import { Request, Response } from 'express';
import { bookingLogger } from '@/features/company/bookings/logger/Booking_Logger';
import { rescheduleBookingZodSchema } from '@/features/company/bookings/operations/reschedule/zod_schema/Reschedule_Booking_Zod_Schema';
import { sendResponse } from '@/utilities/http/http-response/Standard_Response';
import { StandardResponseInterface } from '@/utilities/global_interfaces/Standard_Response_Interface';
import { getErrorStatus } from '@/utilities/http/constants/HTTP_Status_Codes';
import { rescheduleBookingService } from '@/features/company/bookings/operations/reschedule/service/Reschedule_Booking_Service';
import { ulidZodSchema } from '@/utilities/global_schemas/ULID_Zod_Schema';

/**
 * Controller: Reschedule booking
 * Route: POST /api/bookings/reschedule/:booking_id
 * Auth: Required
 */
export const rescheduleBookingController = async (req: Request, res: Response) => {
    try {
        bookingLogger.info('Rescheduling booking - controller', {
        ...
        const validationResult = rescheduleBookingZodSchema.safeParse(req.body);
        ...
        const rescheduledBy = req.user!.user_id;
        
        // Call service
        const serviceResponse = await rescheduleBookingService(
            bookingId,
            companyId,
            rescheduledBy,
        ...
        bookingLogger.info('Reschedule booking completed', {
